%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% The MFCC feature extraction for all the data
...
%dest_org = strcat(upper_org2, '/MFCC_win32ms_envelop');
%dest_org = strcat(upper_org2, '/MFCC_win186ms');
dest_org = strcat(upper_org2, '/MFCC_win32ms');
dest_dir = [{'/human_09/'}, ...
       {'/human_animal_09/'}, ...
       {'/human_10/'},...
       {'/human_animal_10/'} ];
...
%             end
           ...
           feaName = strcat(pathDest,filename(1:indx2-1),'MFCC_','Fea',segNum, '.mat');
